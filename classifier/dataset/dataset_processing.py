...
class DatasetProcessingWithImagepath(Dataset):
    def __init__(self, data_path, img_filename, transform=None):
        self.img_path = data_path
        self.transform = transform
        # reading img file from file
    ...
    def __getitem__(self, index):
        img_file = os.path.join(self.img_path, self.img_filename[index])
        ...
        # Include the full image path in the return values
        return img, label, lesion, img_file
